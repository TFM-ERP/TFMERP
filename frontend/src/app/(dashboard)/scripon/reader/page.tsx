...
export default function ScriptOnWorkspace() {
  ...
  const onNav = (k: string) => { if (k === 'home') return router.push('/scripon'); if (k === 'library') return router.push('/scripon/library'); if (k === 'coverage') return router.push('/scripon/coverage'); if (k !== 'reader') return onAction(k); };
  ...
  const onAction = (a: string) => {
    ...
    if (a === 'compare') return router.push('/scripon/revisions');
    if (a === 'notes') return router.push('/scripon/notes');
    if (a === 'coverage') return router.push('/scripon/coverage');
    ...
    if (a === 'breakdown') return router.push('/scripon/breakdown');
    if (a === 'doctor') return router.push('/scripon/doctor');
    if (a === 'schedule') return router.push('/scripon/schedule');
    if (a === 'reports') return router.push('/scripon/reports');
    if (a === 'studio') return router.push('/scripon/studio');
    if (a === 'greenlight') return router.push('/scripon/greenlight');
    if (a === 'settings') return router.push('/scripon/settings');
    if (a === 'develop') return router.push('/scripon/studio');
  ...
  return (
    <>
      ...
      <ScriptOnReader
        ...
        onAction={onAction} onRun={runDiagnostics} onBack={() => router.push('/scripon')} onLibrary={() => router.push('/scripon/library')}
        toast={toast}
      />
      )}
