  ...
  return (
    <SonCard className="p-3" style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
      ...
      {engine.tier !== 'LIVE' && <>
        ...
        <label className="son-faint" style={{ fontSize: 11 }}>Default model<input className="son-input" style={{ width: 130, marginTop: 2 }} value={model} onChange={(e) => setModel(e.target.value)} /></label>
