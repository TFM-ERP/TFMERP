'use client';
/** ScriptON Doctor — Doctor workspace route /scripton/doctor. Coverage + diagnostics from productionApi.scripton. */
...
export default function ScriptOnDoctorPage() {
  ...
  const onAction = (k: string) => {
    ...
    if (k === 'compare') return router.push('/scripton/revisions');
