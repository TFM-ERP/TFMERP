  ...
  return (
    <Shell>
      <div className="pwrap">
        <div className="frame">
          <div className="ptabs">
            <span className="ptab" onClick={() => router.push('/scripton/library')}>{t('Library')}</span>
          ...
          <div className="head">
            ...
            <div className="hactions">
              ...
              {docId ? <button className="btn outline" onClick={() => router.push('/scripton/script?doc=' + docId)}>▤ {t('Read script')}</button> : null}
              ...
              <button className="btn ghost" onClick={() => router.push('/scripton/library')}>{dir === 'rtl' ? '→' : '←'} {t('Library')}</button>
            </div>
          </div>
