      ...
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-[20px] font-extrabold leading-tight" style={{ color: 'var(--text-1)' }}>Chart of Accounts</h1>
            <p className="text-sm" style={{ color: 'var(--text-3)' }}>{accounts.length} ledger accounts.</p>
          </div>
        </div>
