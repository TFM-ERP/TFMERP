          ...
          <div className="card space-y-4">
            ...
            {editing ? (
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><label className="label">Email</label><input type="email" className="input w-full" {...ef('email')} /></div>
                <div className="col-span-2"><label className="label">Phone</label><input className="input w-full" {...ef('phone')} /></div>
              </div>
            ) : (
