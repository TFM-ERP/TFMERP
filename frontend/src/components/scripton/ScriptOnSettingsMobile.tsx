...
import type { SxRun } from './ScriptOnSettings';
...
export default function ScriptOnSettingsMobile(p:P){const{dir,t}=useLocale();return(<div className="dvm" dir={dir}><style dangerouslySetInnerHTML={{__html:M_CSS}}/>
