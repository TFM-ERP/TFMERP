...
import type { SxNote } from './ScriptOnNotes';
...
export default function ScriptOnNotesMobile(p:P){const{dir,t}=useLocale();return(<div className="dvm" dir={dir}><style dangerouslySetInnerHTML={{__html:M_CSS}}/>
