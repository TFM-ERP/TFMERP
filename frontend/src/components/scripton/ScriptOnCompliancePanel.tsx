'use client';
/** ScriptON Doctor — Rating & Compliance (P3). Dark overlay; scripton.rating + cultureScreen. Estimates only — boards decide. */
...
export default function ScriptOnCompliancePanel({ projectId, revisionId, onClose }: { projectId: string; revisionId?: string; onClose: () => void }) {
