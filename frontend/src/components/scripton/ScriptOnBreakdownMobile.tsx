...
import type { SxLens, SxEl, SxDetail } from './ScriptOnBreakdown';
...
export default function ScriptOnBreakdownMobile(props: { title: string; lenses: SxLens[]; activeLens: string; onLens: (k: string) => void; elements: SxEl[]; activeName?: string; onSelect: (n: string) => void; detail: SxDetail; onAction: (k: string) => void; onNav: (k: string) => void; onBack: () => void; }) {
