...
import type { SxStep, SxKCol } from './ScriptOnApprovals';
...
export default function ScriptOnApprovalsMobile(p:P){const{dir,t}=useLocale();return(<div className="dvm" dir={dir}><style dangerouslySetInnerHTML={{__html:M_CSS}}/>
