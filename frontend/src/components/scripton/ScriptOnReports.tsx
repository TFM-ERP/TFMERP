'use client';
/** ScriptON Doctor — Reports & Exports (carbon-copy of design/reports.html). Gallery ⇄ reports.catalog, preview ⇄ scripton.latestCoverage. */
...
export default function ScriptOnReports(props: {
