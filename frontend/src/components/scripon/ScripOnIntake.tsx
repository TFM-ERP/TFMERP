...
/** ScripON — consolidated intake (2-step) with the Lore Atlas. Steers the whole ladder; never writes the story alone. */
...
export default function ScripOnIntake({ projectId, busy, onBegin, onClose }: { projectId: string | null; busy?: boolean; onBegin: (form: any) => void; onClose: () => void }) {
    ...
    <div dir={dir} style={{ position: 'fixed', inset: 0, zIndex: 75, background: C.scrim, overflow: 'auto', fontFamily: 'var(--sx-body)' }}>
      ...
      <div style={{ maxWidth: 1060, margin: '0 auto', padding: '26px 18px 60px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, color: C.gold, textTransform: 'uppercase' }}>{t('ScripON - New Build')}</div>
