'use client';
/** ScripON Doctor — dark-native Budget-fit overlay (replaces the light BudgetFitPanel inside the workspace).
...
export default function ScripOnBudgetFit({ projectId, revisionId, onClose }: { projectId: string; revisionId?: string; onClose: () => void }) {
