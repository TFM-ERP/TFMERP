...
/** ScripON Doctor — Rewrite Slate (P2 creative transforms). Dark overlay; scripton.transform / applyTransform.
...
export default function ScripOnRewriteSlate({ projectId, revisionId, onClose, initialKind }: { projectId: string; revisionId?: string; onClose: () => void; initialKind?: string }) {
