'use client';
/**
 * ScripON · Studio (single-canvas) — route /scripon/settings under the `new`
...
import ReviewProtectionPanel from '@/components/scripon/ReviewProtectionPanel';
...
export default function ScriponStudio(props: StudioProps) {
