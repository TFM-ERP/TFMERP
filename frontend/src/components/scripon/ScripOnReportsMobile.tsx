...
import type { SxReport } from './ScripOnReports';
...
export default function ScripOnReportsMobile(p:P){const{dir,t}=useLocale();return(<div className="dvm" dir={dir}><style dangerouslySetInnerHTML={{__html:M_CSS}}/>
