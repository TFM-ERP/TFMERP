'use client';
/**
 * ScripON · Home (OS landing) — route /scripon under the `new` shell flag.
 ...
 * other ScripON screens and the verified rail cutover.
 */
      ...
      <div className="sx home" data-vp={vp} dir={dir} style={{ position: 'fixed', inset: 0, zIndex: 50 }}>
        <div className="top">
          <div className="tl">
            ...
            <div className="proj">{t('ScripON')}</div>
