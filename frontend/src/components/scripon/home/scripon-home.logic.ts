// Pure logic for the ScripON Home screen — no React, no API, no DOM.
// Everything here is deterministic and unit-tested (scripon-home.logic.test.ts).
...
// ── Cinematic card palette (matches ScripOnLibrary) ──
export const COVERS = [
