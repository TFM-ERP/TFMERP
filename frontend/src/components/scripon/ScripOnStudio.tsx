'use client';
/**
 * ScripON Doctor — Studio (P4 Format + P6 Develop/Adapt). Tabs switch content:
...
/** The cinematic ScripON shell CSS — exported so every screen (incl. Dialect) shares one look. */
...
export default function ScripOnStudio(props: {
