'use client';
/** ScripON Doctor — Reader · TABLET (review-first), carbon-copy of design/tablet-reader.html. Wired to the same props. */
import React from 'react';
import type { SxScene, SxSceneRead } from './ScripOnReader';
...
export default function ScripOnReaderTablet(props: {
