...
export default function ScripOnFormatPanel({ projectId, onClose }: { projectId: string | null; onClose: () => void }) {
    ...
    <div dir={dir} style={{ position: 'fixed', inset: 0, zIndex: 80, background: C.scrim, overflow: 'auto', fontFamily: 'var(--sx-body)' }}>
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '26px 18px 60px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, color: C.gold, textTransform: 'uppercase' }}>{t('ScripON · Doctor')}</div>
