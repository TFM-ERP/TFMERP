'use client';
/** ScripON Doctor — Settings & Governance (carbon-copy of design/settings.html). The AI spine, made legible.
...
export default function ScripOnSettings(props: {
      ...
      <div className="sx" dir={dir} style={{ position: 'fixed', inset: 0, zIndex: 50 }}>
        ...
        <div className="body">
          ...
          <div className="main"><div className="content">
            <div className="phead"><h1>{section === 'protection' ? t('Review Protection') : t('AI Governance')}</h1><div className="sub">{section === 'protection' ? t('Recipient-watermarked, permission-locked, audit-logged review copies. Set the workspace default here.') : t('One model gateway, one audit trail. Every ScripON Doctor run is versioned, scored for confidence, and logged.')}</div></div>
