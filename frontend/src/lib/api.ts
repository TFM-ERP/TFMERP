...
export const productionApi = {
  ...
  scripton: {
    ...
    topVersion: (projectId: string, scriptId?: string) => api.get('/production/scripton/top-version?projectId=' + encodeURIComponent(projectId) + (scriptId ? '&scriptId=' + encodeURIComponent(scriptId) : '')),
...
export const scriptAudioApi = {
  ...
  jobsForRevision: (revisionId: string) => api.get(`/production/audio/jobs-for-revision/${revisionId}`),
  library:       (projectId: string, revisionId?: string) => api.get(`/production/audio/library/${projectId || 'none'}`, { params: { revisionId } }),
