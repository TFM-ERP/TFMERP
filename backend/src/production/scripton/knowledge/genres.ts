...
export const BLEND_LAYERS: { id: string; label: string; ar?: string }[] = [
  ...
  { id: 'comedy', label: 'Comedy', ar: 'كوميديا' },
  { id: 'dark-comedy', label: 'Dark comedy', ar: 'كوميديا سوداء' },
